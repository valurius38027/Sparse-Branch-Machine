...
| `2026-06-30-global-predictive-address-field.md` | Partial — diagnostics, shadow observation, bounded retrieval, frozen read-only guard and Probe-only slot phase accounting implemented; admission/retirement lifecycle pending |
